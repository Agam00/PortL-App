...
const CLEANING = require("../../assets/services/cleaning.png");
const APPLIANCES = require("../../assets/services/appliances.png");
const CARPENTER = require("../../assets/services/carpenter.png");
const PAINTING = require("../../assets/services/painting.png");
const PLUMBING = require("../../assets/services/plumbing.png");
const MOVERS = require("../../assets/services/movers.png");
...
const SERVICES: { key: string; img: ImageSourcePropType }[] = [
  ...
  { key: "Carpenter Service", img: CARPENTER },
  { key: "Home Painting", img: PAINTING },
  { key: "Plumbing Service", img: PLUMBING },
            ...
            active.map((b) => {
              ...
              return (
                <View key={b.id} className="flex-row items-center gap-3 rounded-2xl bg-surface p-4" style={shadowCard}>
                  <Image source={IMG_BY_CATEGORY[b.category] ?? CLEANING} style={{ width: 52, height: 52 }} resizeMode="contain" />
